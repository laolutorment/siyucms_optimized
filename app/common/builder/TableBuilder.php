...
class TableBuilder
{
    ...
    private $_vars = [
        ...
        'layer_open'       => false,        // 添加/编辑等页启用layer弹层加载
        'fixed_left'       => 0,           // 左侧固定列数
...
/**
     ...
     * @return $this
     */
    public function setTableTem($table_tem_set = '')
    {
        if ($table_tem_set != '') {
           $ZTX_options= \app\common\model\TableTemSet::where('id', $table_tem_set)->find();
            $this->_vars['ZTX_options'] = $ZTX_options;
     ...
     * @return $this
     */
    public function addColumn($name = '', $title = '', $type = '', $default = '', $param = '', $class = '', $sortable = 'false', $align = '', $visible = '', $formatter = '')
    {
        $column = [
            'name'     => $name,     // 字段名称
            'title'    => $title,    // 字段别名
